...
final class LoginViewContoller: UIViewController {
    ...
    lazy var stackView: UIStackView = {
        let st = UIStackView(arrangedSubviews: [emailTextFieldView, passwordTextFieldView, loginButton, registerButton])
        st.spacing = 18
        st.axis = .vertical
    ...
    // 비밀번호 재설정 버튼
    private let passowrdResetButton: UIButton = {
        let button = UIButton()
        button.backgroundColor = .clear
    ...
    func makeUI() {
        ...
        view.addSubview(passowrdResetButton)
        ...
        passowrdResetButton.translatesAutoresizingMaskIntoConstraints = false
        ...
        NSLayoutConstraint.activate([
            ...
            passowrdResetButton.topAnchor.constraint(equalTo: stackView.bottomAnchor, constant: 10),
            passowrdResetButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
            passowrdResetButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -30),
            passowrdResetButton.heightAnchor.constraint(equalToConstant: textViewHeight)
        ])
    }
